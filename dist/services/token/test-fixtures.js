...
export const SPECIAL_CHARS_TOKEN = {
    input: {
        tokenType: 'erc20',
...
export const ZERO_MARKET_CAP_TOKEN = {
    input: {
        tokenType: 'erc20',
        name: 'Dead Token',
        symbol: 'DEAD',
...
export const HIGH_DECIMALS_TOKEN = {
    input: {
        tokenType: 'erc20',
...
export const ZERO_DECIMALS_TOKEN = {
    input: {
        tokenType: 'erc20',
...
export function createTokenFixture(overrides) {
