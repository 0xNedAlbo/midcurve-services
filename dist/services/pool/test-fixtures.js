...
export const USDC_ARBITRUM_TOKEN = {
...
export const ACTIVE_POOL_STATE = {
...
export const HIGH_LIQUIDITY_STATE = {
...
export function createPoolFixture(overrides = {}) {
    const input = {
        protocol: 'uniswapv3',
        poolType: 'CL_TICKS',
        token0Id: USDC_TOKEN.id,
